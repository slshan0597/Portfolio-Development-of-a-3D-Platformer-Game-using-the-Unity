// //////////////////////////////////////////////////////////////////////////////
// * 개요
//    - 감지된 입력 타입(Keyboard, Joystick, Touch)에 따른 입력 상태(연결된 UI의 내용 등) 변경
//    - 설정 창(UI)에서 맵핑(Mapping)값 변경 시 적용 및 연결된 UI의 내용 변경
//    - 데이터 형태로 저장 및 불러오기
//
// * 목차
//    1. 인터페이스 ... Line 38
